...
import com.example.instaclone.data.PostRow
...
fun MyPostScreen(navController: NavController, vm: IgViewModel){
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Column(modifier = Modifier.weight(1f).verticalScroll(rememberScrollState())) {
            ...
            OutlinedButton(onClick = { navigateTo(navController,DestinationScreens.Profile) },
                modifier = Modifier
                    .padding(8.dp)
                    .fillMaxWidth(),
                ...
                Text(text = "Edit Profile", color = if (isSystemInDarkTheme()) Color.White else Color.Black)
            }
            ...
            PostList(
                ...
                navigateTo(navController,DestinationScreens.SinglePost, NavParam("post",post))
            }
        }
